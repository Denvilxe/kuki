...
async def ubalive(_, message: Message):
  ...
  alive_pic = "https://telegra.ph/file/ee560e47235b025dd22e8.jpg"
  await message.reply_photo(alive_pic, caption=f"**☑️ Anie Music Userbot is Alive 🌀** \n\n**🤖 Version** \n ↳**Bot Version:** `2.5` \n ↳**Userbot Version:** `0.0` \n\n**🐬 Info**\n ↳**Music Bot:** @{BOT_USERNAME} \n ↳**Owner:** [Click Here](tg://user?id=1950983583)")
